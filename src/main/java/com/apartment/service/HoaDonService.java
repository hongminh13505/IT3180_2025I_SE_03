...
public class HoaDonService {
    ...
    public java.util.List<com.apartment.dto.ThongKeDTO> thongKeTheoThang(int year) {
    ...
    public java.util.List<com.apartment.dto.ThongKeDTO> thongKeTheoNam() {
    ...
    public java.util.List<com.apartment.dto.ThongKeDTO> thongKeTheoLoai(int year, Integer month) {
